...
const Profile = ({ navigation }) => {
    ...
    //         console.log('Random number:', userData.randomNumber);
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            // Make sure the currentUserRandomNumber is not null
            if (currentUserRandomNumber) {
                const userDocument = await firestore().collection('Users').doc(currentUserRandomNumber.toString()).get();
                const user = userDocument.data();
                if (user) {
                    setUserData(user);
                    console.log('This is the userData:', user);
                } else {
                    console.log('No user found with the id:', currentUserRandomNumber);
                }
            } else {
                console.log('No currentUserRandomNumber found');
            }
        };

        fetchUserData();
    }, [currentUserRandomNumber]);
